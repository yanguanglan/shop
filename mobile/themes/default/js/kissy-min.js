...
var KISSY = function(a) {
    var b = this, i, k = 0;
    i = {__BUILD_TIME: "20130701201313", Env: {host: b, nodejs: "function" == typeof require && "object" == typeof exports}, Config: {debug: "", fns: {}}, version: "1.30", config: function(b, j) {
...
(function(a, b) {
    ...
    var l = "__MIX_CIRCULAR", e = this, f = !0, d = Object.create, h = !{toString: 1}.propertyIsEnumerable("toString"), c = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toString,toLocaleString,valueOf".split(",");
    (function(c, a) {
        for (var d in a)
            c[d] = a[d]
    })(a, {stamp: function(c, d, h) {
            if (!c)
                return c;
...
(function(a) {
    ...
    a.mix(a, {noop: function() {
        }, bind: b(0, b, null, 0), rbind: b(0, b, null, 1), later: function(b, k, g, j, l) {
            ...
            return{id: d, interval: g, cancel: function() {
                    this.interval ?
...
(function(a, b) {
    ...
    function k(f, d, h, c) {
        ...
        for (n in d)
            !m(f, n) && m(d, n) && h.push("expected has key '" + n + "', but missing from actual.");
        for (n in f)
            !m(d, n) && m(f, n) && h.push("expected missing key '" + n + "', but present in actual.");
        for (n in d)
            n != e && (a.equals(f[n], d[n], h, c) || c.push("'" + n + "' was '" + (d[n] ? d[n].toString() : d[n]) + "' in expected, but was '" + (f[n] ? f[n].toString() : f[n]) + "' in actual."));
    ...
    a.mix(a, {equals: function(e, d, h, c) {
            h = h || [];
            c = c || [];
    ...
    a.mix(a, {isBoolean: 0, isNumber: 0, isString: 0, isFunction: 0, isArray: 0, isDate: 0, isRegExp: 0, isObject: 0, type: function(a) {
            ...
            try {
                if (g.constructor && !Object.prototype.hasOwnProperty.call(g,
                        "constructor") && !Object.prototype.hasOwnProperty.call(g.constructor.prototype, "isPrototypeOf"))
                    return!1
            } catch (j) {
                return!1
            }
...
(function(a, b) {
    ...
    j.prototype = {constructor: j, then: function(a, c) {
            return e(this, a, c)
        }, fail: function(a) {
            return e(this, 0, a)
        }, fin: function(a) {
    ...
    KISSY.Promise = j;
    j.Defer = k;
    a.mix(j, {when: e, isPromise: g, isResolved: f, isRejected: d, all: function(a) {
            var c = a.length;
            if (!c)
                return a;
...
(function(a) {
    ...
    var i = /^(\/?)([\s\S]+\/(?!$)|\/)?((?:\.{1,2}$|[\s\S]+?)?(\.[^.\/]*)?)$/, k = {resolve: function() {
            ...
            var j =
                    "/" == g.charAt(0), i = "/" == g.slice(-1), g = b(a.filter(g.split("/"), function(a) {
                return!!a
            }), !j).join("/");
            !g && !j && (g = ".");
            g && i && (g += "/");
...
(function(a, b) {
    ...
    var l = /[#\/\?@]/g, e = /[#\?]/g, f = /[#@]/g, d = /#/g, h = RegExp("^(?:([\\w\\d+.-]+):)?(?://(?:([^/?#@]*)@)?([\\w\\d\\-\\u0100-\\uffff.+%]*|\\[[^\\]]+\\])(?::([0-9]+))?)?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$"), c = a.Path, m = {scheme: 1, userInfo: 2, hostname: 3, port: 4, path: 5, query: 6, fragment: 7};
    ...
    j.prototype = {constructor: j, clone: function() {
            var c = new j, b = this;
...
(function(a, b) {
    ...
    var k = a.Env.host, g = k.document, k = (k = k.navigator) && k.userAgent || "", j, l = "", e = "", f, d = [6, 9], h = g && g.createElement("div"), c = [], m = KISSY.UA = {webkit: b, trident: b, gecko: b, presto: b, chrome: b, safari: b, firefox: b, ie: b, opera: b, mobile: b, core: b, shell: b, phantomjs: b, os: b, ipad: b, iphone: b, ipod: b, ios: b, android: b, nodejs: b}, n = function(a) {
        var c = 0;
...
(function(a) {
    ...
    KISSY.Loader.Target = {on: function(a, g) {
            b(this, a, 1).push(g)
        }, detach: function(k, g) {
            var j, l;
            if (k) {
...
(function(a) {
    ...
    a.mix(c, {docHead: function() {
        ...
        normalDepModuleName: function(a, b) {
            ...
            return h ? h : e[b] = h = new g.Module(a.mix({name: b, runtime: c}, d))
            ...
            if (!g || !g.fn)
                c.createModuleInfo(b, d), g = m[d], a.mix(g,
                        {name: d, status: h, fn: e}), a.mix(g, f)
...
(function(a) {
    ...
    a.augment(k, {setValue: function(a) {
            ...
            if (!(b = this.packageInfo)) {
                ...
                for (c in d)
                    a.startsWith(f, c) && c.length > h.length && (h = c);
...
(function(a) {
    ...
    a.mix(a.Loader.Utils, {pollCss: function(a, e) {
            var f;
            f = j[a.href] = {};
            f.node = a;
            f.callback = e;
...
(function(a) {
    ...
    a.mix(a, {getScript: function(l, e, f) {
            var d = e, h = 0, c, m, n, p;
...
(function(a) {
    ...
    a.augment(b, b.Target, {__currentMod: null, __startLoadTime: 0, __startLoadModName: null, add: function(b, j, l) {
            var e = this.runtime;
            if ("string" == typeof b)
                ...
                if (l = j, j = b, i.ie) {
                    ...
                    this.__currentMod = {fn: j, config: l}
        }})
})(KISSY);
(function(a, b) {
    function i(b) {
    ...
    function k(a, b, d) {
        var f, m = b.length;
        for (f = 0; f < m; f++) {
            var j = a, i = b[f], k = d, l = j.runtime, w = void 0, A = void 0, w = l.Env.mods, y = w[i];
    ...
    function g(c, g, j) {
        ...
        var k = c.runtime, l = g.getName(), n = g.getCharset(),
                v = g.getFullPath(), x = 0, w = f.ie, A = "css" == g.getType();
        g.status = h;
        w && !A && (c.__startLoadModName = l, c.__startLoadTime = Number(+new Date));
        a.getScript(v, {attrs: w ? {"data-mod-name": l} : b, success: function() {
                if (g.status == h)
                    if (A)
    ...
    a.augment(j, {use: function(a, b, c) {
            var d, h = new i(function() {
                e.attachModsRecursively(d, f);
                b && b.apply(f, e.getModules(f, a))
            }), f = this.runtime, a = e.getModNamesAsArray(a), a = e.normalizeModNamesWithAlias(f,
                    a);
            d = e.unalias(f, a);
            k(this, d, h);
...
(function(a, b) {
    ...
    function e(b) {
        if (a.Config.debug) {
            var c = [], d, h = [];
            for (d in b)
                h.push.apply(h, b[d]), a.each(b[d].mods, function(a) {
                    c.push(a.name)
                })
        }
    }
    ...
    a.augment(k, {clear: function() {
            ...
            var d = this, h = d.runtime, a = m.getModNamesAsArray(a),
                    a = m.normalizeModNamesWithAlias(h, a), e = m.unalias(h, a);
            m.isAttached(h, e) ? b && (c ? b.apply(null, m.getModules(h, a)) : setTimeout(function() {
                b.apply(null, m.getModules(h, a))
            }, 0)) : (j(d, {modNames: a, unaliasModNames: e, fn: function() {
                    setTimeout(function() {
                        d.loading = 0;
                        g(d)
                    }, 0);
            ...
            for (h = 0; h < b.length; h++)
                e = b[h], m.isAttached(g, e) || (m.isLoaded(g, e) || (c[e] = 1), a.mix(c,
                        d(this, e, j)));
            b = [];
            for (f in c)
                b.push(f);
            ...
            var g = {js: {}, css: {}}, j, i, k, b = e.comboPrefix, l = e.comboSep, A = e.comboMaxFileNum, y = e.comboMaxUrlLength;
            for (i in f)
                for (k in f[i]) {
                    j = [];
                    var B = f[i][k], D = B.packageInfo, C = (d = D.getTag()) ? "?t=" + encodeURIComponent(d) : "", I =
...
(function(a, b) {
    ...
    a.Env.nodejs ? a.config({charset: "utf-8", base: __dirname.replace(/\\/g, "/").replace(/\/$/, "") + "/"}) : a.config(a.mix({comboMaxUrlLength: 2E3,
        comboMaxFileNum: 40, charset: "utf-8", tag: "20130701201313"}, i()));
...
(function(a, b) {
    ...
    if (g.ie)
        try {
            j.execCommand("BackgroundImageCache", !1,
                    !0)
        } catch (q) {
        }
})(KISSY, void 0);
(function(a) {
    ...
    a.config({packages: {gallery: {base: b}, mobile: {base: b}}, modules: {core: {alias: "dom,event,ajax,anim,base,node,json,ua,cookie".split(",")}}})
})(KISSY);
(function(a, b, i) {
    ...
    a({"event/dom": {alias: ["event/dom/base", b.isTouchSupported() ? "event/dom/touch" : "", b.isDeviceMotionSupported() ? "event/dom/shake" : "", b.isHashChangeSupported() ? "" : "event/dom/hashchange", 9 > i.ie ? "event/dom/ie" : "", i.ie ? "" : "event/dom/focusin"]}});
    a({"event/dom/base": {requires: ["dom",
                "event/base"]}});
    ...
    a({menu: {requires: ["component/extension", "node",
...
KISSY.add("dom/base/api", function(a) {
    var b = a.Env.host, i = a.UA, k = {ELEMENT_NODE: 1, ATTRIBUTE_NODE: 2, TEXT_NODE: 3, CDATA_SECTION_NODE: 4, ENTITY_REFERENCE_NODE: 5, ENTITY_NODE: 6, PROCESSING_INSTRUCTION_NODE: 7, COMMENT_NODE: 8, DOCUMENT_NODE: 9, DOCUMENT_TYPE_NODE: 10, DOCUMENT_FRAGMENT_NODE: 11, NOTATION_NODE: 12}, g = {isCustomDomain: function(a) {
...
KISSY.add("dom/base/attr", function(a, b, i) {
    ...
    var g = a.Env.host.document, j = b.NodeType, l = (g = g && g.documentElement) && g.textContent === i ? "innerText" : "textContent", e = b.nodeName, f = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, d = /^(?:button|input|object|select|textarea)$/i, h = /^a(?:rea)?$/i, c = /:|^on/, m = /\r/g, n = {}, p = {val: 1, css: 1, html: 1, text: 1, data: 1, width: 1, height: 1,
        offset: 1, scrollTop: 1, scrollLeft: 1}, o = {tabindex: {get: function(a) {
    ...
    o.style = {get: function(a) {
            return a.style.cssText
        }};
    a.mix(b, {_valHooks: u, _propFix: q, _attrHooks: o, _propHooks: t, _attrNodeHook: s, _attrFix: n, prop: function(c, d, h) {
            var e = b.query(c), f, m;
            ...
            if (c === i) {
                ...
                for (e = h.length - 1; 0 <= e; e--)
                    d = h[e], d.nodeType == j.ELEMENT_NODE ? d[l] = c : d.nodeType ==
...
KISSY.add("dom/base/create", function(a, b, i) {
    ...
    var f = a.Env.host.document, d = b.NodeType, h = a.UA.ie, c = "div", m = f && f.createElement(c), n = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, p = /<([\w:]+)/,
            o = /^\s+/, q = h && 9 > h, r = /<|&#?\w+;/, t = f && "outerHTML"in f.documentElement, s = /^<(\w+)\s*\/?>(?:<\/\1>)?$/;
    a.mix(b, {create: function(h, m, j, k) {
            var l = null;
            if (!h)
                return l;
            if (h.nodeType)
            ...
            return l
        }, _fixCloneAttributes: null, _creators: {div: g}, _defaultCreator: g, html: function(a, c, h, e) {
            ...
            var a = b.get(a), f, g = b._fixCloneAttributes,
                    m;
            if (!a)
                return null;
            m = a.nodeType;
...
KISSY.add("dom/base/data", function(a, b, i) {
    var k = a.Env.host, g = "__ks_data_" + a.now(), j = {}, l = {}, e = {applet: 1, object: 1, embed: 1}, f = {hasData: function(b, d) {
            if (b)
                if (d !== i) {
                    if (d in b)
                        return!0
    ...
    a.mix(b, {__EXPANDO: g, hasData: function(a, e) {
...
KISSY.add("dom/base/insertion", function(a, b) {
    ...
    var j = b.NodeType, l = /^(?:button|input|object|select|textarea)$/i, e = b.nodeName, f = a.makeArray, d = [].splice,
            h = /\/(java|ecma)script/i;
    a.mix(b, {_fixInsertionChecked: null, insertBefore: function(a, b, d) {
            g(a, b, function(a, b) {
    ...
    a.each({prepend: "prependTo",
        append: "appendTo", before: "insertBefore", after: "insertAfter"}, function(a, d) {
        b[d] = b[a]
    });
    return b
}, {requires: ["./api"]});
KISSY.add("dom/base/offset", function(a, b, i) {
    ...
    function g(a, c) {
        var h = {left: 0, top: 0}, e = d(a[m]), f, g = a, c = c || e;
        do {
            if (e == c) {
                var j = g;
                f = k(j);
    ...
    var j = a.Env.host,
            l = j.document, e = b.NodeType, f = l && l.documentElement, d = b.getWindow, h = Math.max, c = parseFloat, m = "ownerDocument", n = "left", p = "top", o = a.isNumber, q = "scrollLeft", r = "scrollTop";
    a.mix(b, {offset: function(a, d, h) {
            if (d === i) {
                var a = b.get(a), e;
                a && (e = g(a, h));
                return e
            ...
            for (e = h.length - 1; 0 <= e; e--) {
                ...
                var j = g(a), k = {}, m = void 0, l = void 0;
                for (l in f)
                    m = c(b.css(a, l)) || 0, k[l] = c(m + f[l] - j[l]);
                b.css(a, k)
            }
            return i
            ...
            if (l = b.get(h)) {
                ...
                k = b.outerWidth(l);
                var r, C, I, z;
                m ? (m = f, r = b.height(m), C = b.width(m), z = {left: b.scrollLeft(m), top: b.scrollTop(m)}, m = h[n] - z[n], l = h[p] - z[p], k = h[n] + k - (z[n] + C), h = h[p] + q - (z[p] + r)) : (r = b.offset(f), C = f.clientHeight, I = f.clientWidth, z = {left: b.scrollLeft(f), top: b.scrollTop(f)},
                ...
                if (j)
                    if (o) {
                        if (0 > m || 0 < k)
                            !0 === g ? b.scrollLeft(f, z.left + m) : !1 === g ? b.scrollLeft(f, z.left + k) : 0 > m ? b.scrollLeft(f,
...
KISSY.add("dom/base/selector", function(a, b, i) {
    ...
    function l(a, c) {
        ...
        if (x.test(a))
            ...
            g = g[3];
            if (c = e ? f(e, c) : c)
                g ? !e || -1 != a.indexOf(s) ? h = [].concat(b._getElementsByClassName(g, j, c)) : (e = f(e, c), d(e, g) && (h =
                        [e])) : j && (h = o(b._getElementsByTagName(j, c)));
            h = h || []
        }
        return h
    }
    ...
    var c = a.Env.host.document,
            m = b.NodeType, n = a.filter, p = a.isArray, o = a.makeArray, q = b._isNodeList, r = b.nodeName, t = Array.prototype.push, s = " ", u = ",", v = a.trim, x = /^#[\w-]+$/, w = /^(?:#([\w-]+))?\s*([\w-]+|\*)?\.?([\w-]+)?$/;
    a.mix(b, {_getAttr: h, _hasSingleClass: d, _getElementById: function(a, c, d, h) {
...
KISSY.add("dom/base/style", function(a, b, i) {
    ...
    var f = a.Env.host, d = a.UA, h = b.nodeName, c = f.document, m = "style", n = /^margin/, p = "width", o = "display" + a.now(), q = parseInt, r = {fillOpacity: 1, fontWeight: 1,
    ...
    a.mix(b, {_camelCase: k, _CUSTOM_STYLES: A, _cssProps: y, _getComputedStyle: function(a, c) {
            ...
            if (d && (d = d.replace("#", x)))
                h = b.get("#" + d, a);
            h || (h = b.create("<style>", {id: d}, a), b.get("head", a).appendChild(h), h.styleSheet ? h.styleSheet.cssText =
...
KISSY.add("dom/ie/attr", function(a, b) {
    ...
    if (8 > (document.documentMode || a.UA.ie))
        ...
        }), j.button = i.value = k, j.option = {get: function(a) {
...
KISSY.add("dom/ie/style", function(a, b) {
    ...
    try {
        null == g.style.opacity && (l.opacity = {get: function(a, b) {
    ...
    a.each(["", "Top", "Left", "Right", "Bottom"], function(a) {
        var b =
                "border" + a + "Width", d = "border" + a + "Style";
        l[b] = {get: function(a, c) {
                var f = c ? a.currentStyle : 0, e = f && "" + f[b] || void 0;
...
KISSY.add("event/base", function(a, b, i, k, g) {
    return a.Event = {_Utils: b, _Object: i, _Observer: k, _ObservableEvent: g}
...
KISSY.add("event/base/object", function(a) {
    ...
    b.prototype = {constructor: b, isDefaultPrevented: i, isPropagationStopped: i, isImmediatePropagationStopped: i, preventDefault: function() {
...
KISSY.add("event/base/observer", function(a) {
    ...
    b.prototype = {constructor: b, equals: function(b) {
            ...
            if (!g || this.groups && this.groups.match(g))
                return g = this.notifyInternal(a,
                        b), !1 === g && a.halt(), g
        }};
    return b
});
KISSY.add("event/base/utils", function(a) {
    var b, i;
    return{splitAndRun: i = function(b, g) {
            b = a.trim(b);
            -1 == b.indexOf(" ") ? g(b) : a.each(b.split(/\s+/), g)
        }, normalizeParam: function(i, g, j) {
            var l = g || {}, l = a.isFunction(g) ? {fn: g, context: j} : a.merge(l), g = b(i), i = g[0];
            l.groups = g[1];
            l.type = i;
            return l
...
KISSY.add("event/custom", function(a, b, i, k) {
    ...
    i = a.mix({_ObservableCustomEvent: k, Target: g}, i);
    a.mix(b, {Target: g, custom: i});
    a.EventTarget = g;
    return i
...
KISSY.add("event/custom/observable", function(a, b, i, k, g) {
    ...
    var l = g._Utils;
    a.extend(j, g._ObservableEvent, {constructor: j, on: function(a) {
            a = new i(a);
    ...
    j.getCustomEvent =
            function(a, b, h) {
                ...
                c = e && e[b];
                !c && h && (c = e[b] = new j({currentTarget: a, type: b}));
                return c
            };
...
KISSY.add("event/custom/observer", function(a, b) {
    ...
    a.extend(i, b._Observer, {keys: ["fn", "context", "groups"]});
    return i
}, {requires: ["event/base"]});
KISSY.add("event/dom/base/api", function(a, b, i, k, g, j, l) {
    ...
    function f(b, c, d) {
        ...
        if (!(g = f.events))
            g = f.events = {};
        f = g[c];
        f || (f = g[c] = new j({type: c, fn: i, currentTarget: b}), f.setup());
        f.on(d);
        b = null
    }
    var d = b._Utils;
    a.mix(b, {add: function(b, c, e, g) {
            c = a.trim(c);
            b = i.query(b);
            ...
            d.batchForType(function(b, c, h, f) {
                ...
                for (f = b.length - 1; 0 <= f; f--) {
                    var g = b[f], i = c, k = h, k = a.merge(k), l = void 0, i =
                            e(k, i), g = j.getCustomEvents(g), l = (g || {}).events;
                    if (g && l)
                        if (i)
                            (l = l[i]) && l.detach(k);
                        else
            ...
            return b.add(a, c, {fn: e, context: f, selector: d})
        }, undelegate: function(a, c, d, e, f) {
            return b.remove(a, c, {fn: e, context: f, selector: d})
            ...
            d.splitAndRun(c, function(c) {
                ...
                c = c[0];
                a.mix(e, {type: c, _ks_groups: l});
                b = i.query(b);
                for (l = b.length - 1; 0 <= l; l--)
                    k = b[l], t = j.getCustomEvent(k, c), !f && !t && (t = new j({type: c, currentTarget: k})), t && (k = t.fire(e, f), !1 !== g && (g = k))
            });
            return g
...
KISSY.add("event/dom/base", function(a, b, i, k, g, j) {
    a.mix(b, {KeyCodes: i, _DOMUtils: k, Gesture: g, _Special: j});
    return b
...
KISSY.add("event/dom/base/key-codes", function(a) {
    var b = a.UA, i = {MAC_ENTER: 3, BACKSPACE: 8, TAB: 9, NUM_CENTER: 12, ENTER: 13, SHIFT: 16, CTRL: 17, ALT: 18, PAUSE: 19, CAPS_LOCK: 20, ESC: 27, SPACE: 32, PAGE_UP: 33, PAGE_DOWN: 34, END: 35, HOME: 36, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40, PRINT_SCREEN: 44, INSERT: 45, DELETE: 46, ZERO: 48, ONE: 49, TWO: 50, THREE: 51, FOUR: 52, FIVE: 53, SIX: 54, SEVEN: 55, EIGHT: 56, NINE: 57, QUESTION_MARK: 63, A: 65, B: 66, C: 67, D: 68, E: 69, F: 70, G: 71, H: 72, I: 73, J: 74, K: 75, L: 76, M: 77, N: 78, O: 79, P: 80, Q: 81, R: 82, S: 83, T: 84, U: 85, V: 86, W: 87, X: 88,
...
KISSY.add("event/dom/base/mouseenter", function(a, b, i, k) {
    a.each([{name: "mouseenter", fix: "mouseover"}, {name: "mouseleave", fix: "mouseout"}], function(a) {
        k[a.name] = {onFix: a.fix, delegateFix: a.fix, handle: function(a, b, e) {
...
KISSY.add("event/dom/base/mousewheel", function(a, b) {
    ...
    b.mousewheel = {onFix: i, delegateFix: i}
}, {requires: ["./special"]});
KISSY.add("event/dom/base/object", function(a, b, i) {
    ...
    function j(b) {
        ...
        !c && !d && (d = e);
        (c !== i || d !== i || e !== i) && a.mix(b, {deltaY: d, delta: e, deltaX: c})
    }
    ...
    a.extend(e, l._ObservableEvent, {setup: function() {
            ...
            if (i &&
                ...
                for (; h != c; ) {
                    ...
                    l.length && f.push({currentTarget: h, currentTargetObservers: l});
                    h = h.parentNode || c
                }
            f.push({currentTarget: c, currentTargetObservers: e.slice(i)});
            j = 0;
            ...
            var d = d || {}, c = this.type, f =
                    i[c];
            f && f.onFix && (c = f.onFix);
            var g, l, f = this.currentTarget, k = !0;
            d.type = c;
            d instanceof j || (l = d, d = new j({currentTarget: f, target: f}), a.mix(d, l));
            l = f;
            g = b.getWindow(l.ownerDocument || l);
            var q = g.document, r = [], t = 0, s = "on" + c;
            do
                r.push(l), l = l.parentNode || l.ownerDocument || l === q && g;
            while (l);
            l = r[t];
            do {
                d.currentTarget = l;
            ...
            if (!h && !d.isDefaultPrevented()) {
                ...
                try {
                    if (s &&
                            f[c] && ("focus" !== c && "blur" !== c || 0 !== f.offsetWidth) && !a.isWindow(f))
            ...
            var b, c = i[this.type] ||
                    {}, e = "selector"in a, g = a.selector, j = a.context, l = a.fn, k = this.currentTarget, r = this.observers, a = a.groups;
            if (r.length) {
                a && (b = f.getGroupsRe(a));
            ...
            var b =
                    this.type, h, c, e = i[b] || {}, f = this.currentTarget, g = k.data(f);
            if (g && (h = g.events, this.hasObserver() || (c = g.handle, (!e.tearDown || !1 === e.tearDown.call(f, b)) && k.simpleRemove(f, b, c), delete h[b]), a.isEmptyObject(h)))
...
KISSY.add("event/dom/base/observer", function(a, b, i) {
    ...
    a.extend(k, i._Observer, {keys: "fn,selector,data,context,originalType,groups,last".split(","), notifyInternal: function(a, j) {
            var i, e, f = a.type;
...
KISSY.add("event/dom/base/utils", function(a, b) {
    var i = a.Env.host.document;
    return{simpleAdd: i && i.addEventListener ? function(a, b, j, i) {
...
KISSY.add("event/dom/base/valuechange", function(a, b, i, k) {
    ...
    function l(a) {
        ...
        d !== h && (b.fireHandler(a, c, {prevVal: h, newVal: d}), i.data(a, n, d))
    }
    function e(a) {
...
KISSY.add("event/dom/hashchange", function(a, b, i) {
    ...
    var d = "<html><head><title>" + (l && l.title || "") + " - {hash}</title>{head}</head><body>{hash}</body></html>", h = function() {
        ...
        var h =
                a.substitute(d, {hash: a.escapeHTML(b), head: i.isCustomDomain() ? "<script>document.domain = '" + l.domain + "';<\/script>" : ""}), e = r.contentWindow.document;
        try {
...
KISSY.add("event/dom/ie/change", function(a, b, i) {
    ...
    function l(a) {
        a = a.target;
        f.test(a.nodeName) && !a.__changeHandler && (a.__changeHandler = 1, b.on(a, "change", {fn: e, last: 1}))
    }
    function e(a) {
    ...
    b._Special.change = {setup: function() {
            ...
            if (f.test(this.nodeName))
                ...
                b.remove(this, "beforeactivate", l), a.each(i.query("textarea,input,select", this), function(a) {
                    a.__changeHandler && (a.__changeHandler = 0, b.remove(a, "change", {fn: e, last: 1}))
                })
        }}
}, {requires: ["event/dom/base",
        "dom"]});
...
KISSY.add("event/dom/ie/submit", function(a, b, i) {
    function k(a) {
        ...
        if ((a = "input" == e || "button" == e ? a.form : null) && !a.__submit__fix)
            a.__submit__fix = 1, b.on(a, "submit", {fn: g, last: 1})
    }
    function g(a) {
    ...
    b._Special.submit = {setup: function() {
            ...
            a.each(i.query("form",
                    this), function(a) {
                a.__submit__fix && (a.__submit__fix = 0, b.remove(a, "submit", {fn: g, last: 1}))
            })
        }}
}, {requires: ["event/dom/base", "dom"]});
KISSY.add("event/dom/shake", function(a, b, i) {
    ...
    var g = b._Special, j = 5, l = 20, e = 0, f, d, h, c = Math.max, m = Math.abs, n = a.Env.host, p = a.buffer(function() {
        e && (b.fireHandler(n, "shake", {accelerationIncludingGravity: {x: f, y: d, z: h}}), f = i, e = 0)
    }, 250);
    g.shake = {setup: function() {
...
KISSY.add("event/dom/touch/double-tap", function(a, b, i, k) {
    ...
    a.extend(g, k, {onTouchStart: function(a) {
            ...
            if (b && (h = e - b, 300 > h)) {
                this.lastEndTime = 0;
                i.fire(f, "doubleTap",
                        {touch: d, duration: h / 1E3});
                return
            }
            h = e - this.startTime;
            300 < h ? i.fire(f, "singleTap", {touch: d, duration: h / 1E3}) : this.singleTapTimer = setTimeout(function() {
                i.fire(f, "singleTap", {touch: d, duration: h / 1E3})
            }, 300)
        }});
    b.singleTap = b.doubleTap = {handle: new g};
    return g
...
KISSY.add("event/dom/touch/handle", function(a, b, i, k, g) {
    ...
    return{addDocumentHandle: function(a, c) {
...
KISSY.add("event/dom/touch/multi-touch", function(a, b) {
    ...
    i.prototype = {requiredTouchCount: 2, onTouchStart: function(a) {
...
KISSY.add("event/dom/touch/pinch", function(a, b, i, k, g) {
    ...
    a.extend(j, k, {onTouchMove: function(b) {
            if (this.isTracking) {
                ...
                d = Math.sqrt(d * d + h * h);
                this.lastTouches = f;
                this.isStarted ? i.fire(this.target, "pinch", a.mix(b, {distance: d, scale: d / this.startDistance})) : (this.isStarted = !0, this.startDistance = d, f = this.target = this.getCommonTarget(b), i.fire(f, "pinchStart", a.mix(b,
                        {distance: d, scale: 1})))
            }
        }, fireEnd: function(b) {
            i.fire(this.target, "pinchEnd", a.mix(b, {touches: this.lastTouches}))
        }});
    k = new j;
...
KISSY.add("event/dom/touch/rotate", function(a, b, i, k, g, j) {
    ...
    var f = 180 / Math.PI;
    a.extend(l, i, {onTouchMove: function(b) {
            if (this.isTracking) {
                ...
                this.lastTouches = e;
                this.lastAngle = c;
                this.isStarted ? k.fire(this.target, "rotate", a.mix(b, {angle: c,
                    rotation: c - this.startAngle})) : (this.isStarted = !0, this.startAngle = c, this.target = this.getCommonTarget(b), k.fire(this.target, "rotateStart", a.mix(b, {angle: c, rotation: 0})))
            }
        }, end: function() {
            this.lastAngle = j;
    ...
    i = new l;
    b.rotateEnd = b.rotateStart = {handle: i};
    b.rotate = {handle: i, setup: function() {
            k.on(this, g.move, e)
        }, tearDown: function() {
...
KISSY.add("event/dom/touch/swipe", function(a, b, i, k) {
    function g(a, b, c) {
        ...
        if (a.isHorizontal)
            ...
            return!1;
        i.fire(b.target, c ? e : l, {originalEvent: b.originalEvent, touch: g, direction: j, distance: o, duration: (b.timeStamp -
                    a.startTime) / 1E3})
    }
    function j() {
    }
    var l = "swipe", e = "swiping", f = 50;
    a.extend(j, k, {onTouchStart: function(a) {
...
KISSY.add("event/dom/touch/tap-hold", function(a, b, i, k, g) {
    ...
    a.extend(j, i, {onTouchStart: function(b) {
...
KISSY.add("event/dom/touch/tap", function(a, b, i, k) {
    ...
    a.extend(g, k, {onTouchMove: function() {
            return!1
        }, onTouchEnd: function(a) {
            i.fire(a.target, "tap", {touch: a.changedTouches[0]})
        }});
    b.tap = {handle: new g};
    return g
}, {requires: ["./handle-map", "event/dom/base", "./single-touch"]});
        ...
        switch (typeof t) {
            ...
            case "object":
                ...
                if (d && "object" === typeof d) {
                    ...
                    for (g in t)
                        Object.hasOwnProperty.call(t, g) && (j = i(g, t)) && r.push(b(g) + (l ? ": " : ":") + j);
                j = 0 === r.length ? "{}" : l ? "{\n" + l + r.join(",\n" + l) + "\n" +
                        q + "}" : "{" + r.join(",") + "}";
                l = q;
                return j
...
KISSY.add("ajax", function(a, b, i) {
    function k(b, l, e, f, d) {
        ...
        return i({type: d || "get", url: b, data: l, success: e, dataType: f})
    }
    var g = void 0;
    a.mix(i, {serialize: b.serialize, get: k, post: function(b, i, e, f) {
            a.isFunction(i) && (f = e, e = i, i = g);
            return k(b, i, e, f, "post")
        }, jsonp: function(b, i, e) {
            a.isFunction(i) && (e = i, i = g);
            return k(b, i, e, "jsonp")
        }, getScript: a.getScript, getJSON: function(b, i, e) {
            a.isFunction(i) && (e = i, i = g);
            return k(b, i, e, "json")
        }, upload: function(b, k, e, f, d) {
            a.isFunction(e) && (d = f, f = e, e =
                    g);
            return i({url: b, type: "post", dataType: d, form: k, data: e, success: f})
        }});
    a.mix(a, {Ajax: i, IO: i, ajax: i, io: i, jsonp: i.jsonp});
    return i
...
KISSY.add("ajax/base", function(a, b, i, k) {
    function g(b) {
        ...
        !("cache"in b) && a.inArray(g[0], ["script", "jsonp"]) && (b.cache =
                !1);
    ...
    function l(b) {
        ...
        h.call(d);
        b = g(b);
        a.mix(d, {responseData: null, config: b || {}, timeoutTimer: null, responseText: null, responseXML: null, responseHeadersString: "", responseHeaders: null,
    ...
    var e = /^(?:about|app|app\-storage|.+\-extension|file|widget)$/, f = /\s+/, d = function(a) {
        return a
    }, h = a.Promise, c = /^(?:GET|HEAD)$/, m = new a.Uri((a.Env.host.location || {}).href), e = m && e.test(m.getScheme()), n = {}, p = {type: "GET", contentType: "application/x-www-form-urlencoded; charset=UTF-8", async: !0,
    ...
    a.mix(l, i.Target);
    a.mix(l, {isLocal: e, setupConfig: function(b) {
            a.mix(p, b, {deep: !0})
...
KISSY.add("ajax/form-serializer", function(a, b) {
    ...
    return j = {serialize: function(b, f) {
...
KISSY.add("ajax/form", function(a, b, i, k) {
    b.on("start", function(b) {
        ...
        if (e = b.form)
            j = i.get(e), l = j.encoding || j.enctype, e = b.data, "multipart/form-data" != l.toLowerCase() ? (j = k.getFormData(j), b.hasContent ? (j = a.param(j, void 0, void 0, b.serializeArray), b.data = e ? b.data + ("&" + j) : j) : b.uri.query.add(j)) : (e = b.dataType, b = e[0], "*" == b && (b = "text"), e.length = 2, e[0] = "iframe", e[1] = b)
    });
    return b
...
KISSY.add("ajax/iframe-transport", function(a, b, i, k) {
    ...
    function j(f, d, h) {
        ...
        a.each(f, function(f, l) {
            ...
            for (i = 0; i < j.length; i++)
                k = e.createElement("input"), k.type = "hidden", k.name = l + (g && h ? "[]" : ""), k.value = j[i], b.append(k,
                        d), c.push(k)
        });
        return c
    }
    ...
    a.augment(l, {send: function() {
            ...
            d.form = q;
            l = g(e);
            b.attr(q, {target: l.id, action: e._getUrlForSend(),
                method: "post"});
            o && (p = a.unparam(o));
    ...
    a.extend(b, a.Promise, {setRequestHeader: function(a, b) {
            ...
            if (2 === this.state) {
                if (!(e = this.responseHeaders))
                    for (e = this.responseHeaders =
                    {}; b = g.exec(this.responseHeadersString); )
                        e[b[1]] = b[2];
                b = e[a]
            }
            return b === i ? null : b
...
KISSY.add("ajax/script-transport", function(a, b, i, k) {
    ...
    a.augment(g, {send: function() {
            var a = this, b, d = a.io, h = d.config, c = l.head || l.getElementsByTagName("head")[0] ||
                    l.documentElement;
            a.head = c;
            ...
            if (d && (b || !d.readyState || /loaded|complete/.test(d.readyState) || "error" == a))
                d.onerror = d.onload = d.onreadystatechange = null, c && d.parentNode && c.removeChild(d),
...
KISSY.add("ajax/sub-domain-transport", function(a, b, i, k) {
    ...
    a.augment(g, b.proto, {send: function() {
            ...
            c && c.ready ? (this.nativeXhr = b.nativeXhr(0, c.iframe.contentWindow)) &&
                    this.sendInternal() : (c ? f = c.iframe : (c = e[h] = {}, f = c.iframe = l.createElement("iframe"), k.css(f, {position: "absolute", left: "-9999px", top: "-9999px"}), k.prepend(f, l.body || l.documentElement), c = new a.Uri, c.setScheme(d.getScheme()), c.setPort(d.getPort()), c.setHostname(h), c.setPath(g), f.src = c.toString()), i.on(f, "load", j, this))
        }});
    return g
...
KISSY.add("ajax/xdr-flash-transport", function(a, b, i) {
    ...
    a.augment(g,
            {send: function() {
                    ...
                    e ? (b._uid = a.guid(), j[b._uid] = b, e.send(c._getUrlForSend(), {id: b._uid, uid: b._uid, method: d.type, data: d.hasContent && d.data || {}})) : setTimeout(function() {
                        b.send()
                    }, 200)
                }, abort: function() {
                    e.abort(this._uid)
                    ...
                    switch (a) {
                        ...
                        case "failure":
                            delete j[e], d = {status: "status"in g ? g.status : 500, statusText: g.statusText || a}
                    }
...
KISSY.add("ajax/xhr-transport-base", function(a, b) {
    ...
    var g = a.Env.host, j = 7 < a.UA.ie && g.XDomainRequest, l = {proto: {}}, e = {}, f = {};
...
KISSY.add("ajax/xhr-transport", function(a, b, i, k, g) {
    ...
    a.augment(j, i.proto, {send: function() {
            this.sendInternal()
        }});
    b.setupTransport("*", j);
    return b
...
KISSY.add("base/attribute", function(a, b) {
    ...
    function h(a, c, g, h, i) {
        ...
        if (!1 === g)
            return g;
        h.silent || (g = l(a)[c], k(a, "after", c, n, g, w), i ? i.push({prevVal: n, newVal: g, attrName: c, subAttrName: w}) : k(a, "",
                "*", [n], [g], [w], [c]));
        return a
    }
    function c() {
    ...
    c.prototype = {getAttrs: function() {
            ...
            if (a.isPlainObject(c)) {
                ...
                for (c in d)
                    (g = n(this, c, d[c], d)) !== b && i.push(g);
                if (i.length)
                    return e && e.error && e.error(i),
                            !1;
                for (c in d)
                    h(this, c, d[c], e, f);
                var j = [], l = [], m = [], p = [];
...
KISSY.add("anim/base", function(a, b, i, k, g, j, l) {
    function e(c, d, g, h, i) {
        if (c.el)
            return g = c.el, d = c.props, delete c.el, delete c.props, new e(g, d, c);
        if (c = b.get(c)) {
            ...
            g = a.isPlainObject(g) ? a.clone(g) : {duration: parseFloat(g) || void 0, easing: h, complete: i};
            g = a.merge(s, g);
            g.el = c;
            g.props = d;
            this.config = g;
    ...
    function d() {
        ...
        if (!1 === this.fire("beforeStart"))
            ...
            if (e.nodeType ==
                    q.ELEMENT_NODE && (o.width || o.height))
                f = e.style, a.mix(d, {overflow: f.overflow, "overflow-x": f.overflowX, "overflow-y": f.overflowY}), f.overflow = "hidden", "inline" === b.css(e, "display") && "none" === b.css(e, "float") && (p.ie ? f.zoom = 1 : f.display = "inline-block");
            ...
            for (l in o) {
                f = a.trim(o[l]);
                var s, v, x = {prop: l, anim: this, easing: m[l]}, E = j.getFx(x);
    ...
    var p = a.UA, o = b._camelCase, q = b.NodeType,
    ...
    e.SHORT_HANDS = t;
    e.prototype = {constructor: e, isRunning: function() {
            ...
            if (this.isPaused()) {
                ...
                var c = this.config.el, d = b.data(c,
                        x);
...
KISSY.add("anim/color", function(a, b, i, k) {
    ...
    var l = 16, e = Math.floor, f = {black: [0, 0, 0], silver: [192,
            192, 192], gray: [128, 128, 128], white: [255, 255, 255], maroon: [128, 0, 0], red: [255, 0, 0], purple: [128, 0, 128], fuchsia: [255, 0, 255], green: [0, 128, 0], lime: [0, 255, 0], olive: [128, 128, 0], yellow: [255, 255, 0], navy: [0, 0, 128], blue: [0, 0, 255], teal: [0, 128, 128], aqua: [0, 255, 255]}, d = /^rgb\(([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\)$/i, h = /^rgba\(([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+),\s*([0-9]+)\)$/i, c = /^#?([0-9A-F]{1,2})([0-9A-F]{1,2})([0-9A-F]{1,2})$/i, b = i.SHORT_HANDS;
...
KISSY.add("anim/easing", function() {
    var a = Math.PI, b = Math.pow, i = Math.sin, k = {swing: function(b) {
...
KISSY.add("anim/queue", function(a, b) {
    ...
    var g = a.guid("ks-queue-" + a.now() + "-"), j = a.guid("ks-queue-" + a.now() + "-"), l = {queueCollectionKey: g, queue: function(a) {
...
KISSY.add("node/anim", function(a, b, i, k, g) {
    ...
    a.each({show: j("show", 3), hide: j("hide", 3), toggle: j("toggle", 3), fadeIn: j("show", 3, 2), fadeOut: j("hide", 3, 2), fadeToggle: j("toggle",
                3, 2), slideDown: j("show", 1), slideUp: j("hide", 1), slideToggle: j("toggle", 1)}, function(e, f) {
