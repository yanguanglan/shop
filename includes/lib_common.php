...
function clear_tpl_files($is_cache = true, $ext = '')
{
    ...
    if ($is_cache)
    {
        ...
        $cachemobile_dir = ROOT_PATH . $tmp_dir . '/cachesmobile/'; //by Leah
        ...
        for($i = 0; $i < 16; $i++)
        {
            ...
            $cachehash_dir = $cachemobile_dir . dechex($i); // by Leah
            $dirs[] = $cachehash_dir.'/';   //by Leah
            $dirs[] = $hash_dir . '/';
        }
//         print_r($dirs );
    }
    else
    {
        ...
        $dirs[] = ROOT_PATH . $tmp_dir . '/compiledmobile/'; //by Leah
