...
?>
    ...
    <?php if ($this->_var['goods']['rooms'] != ''): ?><a href="pre.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" class="bnt_blue">立即预订</a><?php else: ?><a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="bnt_blue"><?php if ($this->_var['goods']['rooms'] != ''): ?>立即预订<?php else: ?>立即购买<?php endif; ?></a><?php endif; ?>
