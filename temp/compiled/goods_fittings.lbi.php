...
<?php if ($this->_var['fittings']): ?>
 ...
 <form action="flow.php" method="post" name="ECS_ALL_addcart" >
  ...
  <tr>
    <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_42385900_1390445326');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_42385900_1390445326']):
?>
    <td>
    <div class="div_ul">
      <li class="goodsimg">
      <a href="<?php echo $this->_var['goods_0_42385900_1390445326']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods_0_42385900_1390445326']['goods_thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods_0_42385900_1390445326']['name']); ?>" class="B_blue" /></a>
      </li>
      <li>
      <a  href="<?php echo $this->_var['goods_0_42385900_1390445326']['url']; ?>" class="name" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods_0_42385900_1390445326']['goods_name']); ?>"><?php echo htmlspecialchars($this->_var['goods_0_42385900_1390445326']['short_name']); ?></a> 
     <font class="f1"><?php echo $this->_var['goods_0_42385900_1390445326']['fittings_price']; ?></font> <input name="box[]" type="checkbox" id="goods_ids" value="<?php echo $this->_var['goods_0_42385900_1390445326']['fittings_price_nformat']; ?>"  onClick="qq(<?php echo $this->_var['goods_0_42385900_1390445326']['goods_id']; ?>);"> 
	 
	 <input name="goods_id[]" style="display:none;"  type="checkbox" id="goods_id_<?php echo $this->_var['goods_0_42385900_1390445326']['goods_id']; ?>" value="<?php echo $this->_var['goods_0_42385900_1390445326']['goods_id']; ?>" > 
