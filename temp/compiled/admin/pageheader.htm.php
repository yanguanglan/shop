...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/transport.js,common.js,jquery-1.4.2.min.js')); ?>
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/jquery-1.4.2.min.js')); ?>
