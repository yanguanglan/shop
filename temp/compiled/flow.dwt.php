...
<div class="block930"  >
  ...
  <div class="step_out">
   <img style="float:left" src="themes/tmall/images/my_car.gif" /> 
  <div class="step">
  
  <img src="themes/tmall/images/step1.gif" />
    ...
    <h6><span><?php echo $this->_var['lang']['goods_list']; ?></span></h6>
      ...
      <div class="flowBox_in">
        <form id="formCart" name="formCart" method="post" action="flow.php">
           <table width="100%" align="center" border="0" cellpadding="5" cellspacing="2" bgcolor="#ffffff">
            <tr>
              <th class="th" bgcolor="#ffffff"><?php echo $this->_var['lang']['goods_name']; ?></th>
      <?php if ($this->_var['show_goods_attribute'] == 1): ?>
              <th class="th1" bgcolor="#ffffff"><?php echo $this->_var['lang']['goods_attr']; ?></th>
              <?php endif; ?>
              <?php if ($this->_var['show_marketprice']): ?>
              <th class="th1" bgcolor="#ffffff"><?php echo $this->_var['lang']['market_prices']; ?></th>
              <?php endif; ?>
              <th class="th1" bgcolor="#ffffff"><?php echo $this->_var['lang']['shop_prices']; ?></th>
              <th class="th1" bgcolor="#ffffff"><?php echo $this->_var['lang']['number']; ?></th>
              <th class="th1" bgcolor="#ffffff"><?php echo $this->_var['lang']['subtotal']; ?></th>
              <th class="th1" bgcolor="#ffffff"><?php echo $this->_var['lang']['handle']; ?></th>
            </tr>
              ...
              <td bgcolor="#ffffff" align="center">
                <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                  <?php if ($this->_var['show_goods_thumb'] == 1): ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" style="color:#2652A5" class="f6"><?php echo $this->_var['goods']['goods_name']; ?></a>
                  <?php elseif ($this->_var['show_goods_thumb'] == 2): ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img style="width:50px" src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" /></a>
                  <?php else: ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img style="width:50px"  src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" /></a><br />
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" style="color:#2652A5" class="f6"><?php echo $this->_var['goods']['goods_name']; ?></a>
                  <?php endif; ?>
...
?>
              ...
              <?php endif; ?>
              <td align="center" bgcolor="#ffffff"><span class="f1"><?php echo $this->_var['goods']['goods_price']; ?></span></td>
              ...
              <td align="center" bgcolor="#ffffff"><span class="f1"><?php echo $this->_var['goods']['subtotal']; ?></span></td>
              <td align="center" bgcolor="#ffffff">
          ...
          <table  class="tr1" width="100%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#aacded">
            <tr >
              <td bgcolor="#ffffff">
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#aacded">
          <tr>
            <td bgcolor="#ffffff"><a href="./"><img src="themes/tmall/images/continue.gif" alt="continue" /></a></td>
            <td bgcolor="#ffffff" align="right"><a href="flow.php?step=checkout"><img src="themes/tmall/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
  ...
  <img style="float:left" src="themes/tmall/images/flow_2_t.gif" />
  
  <div class="flowBox_in2">  
  
  
    <h6><span><?php echo $this->_var['lang']['label_collection']; ?></span></h6>
    <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
...
?>
   ...
   <img style="float:left" src="themes/tmall/images/flow_2_b.gif" />      
        </div>
      <?php endif; ?>
  ...
  <div class="flowBox_in2" style=" border:1px solid #CCCCCC">  
...
?>
            <ul class="clearfix">
              ...
              <li>
               ...
               <font class="f1" style="display:block; padding:3px 0"><?php echo $this->_var['fittings']['fittings_price']; ?></font> 
          
                <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/tmall/images/bnt_buy2.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a>
              </li>
            </ul>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="image" src="themes/tmall/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
            </tr>
            <?php endif; ?>
          </table>
  ...
  <img src="themes/tmall/images/step2.gif" />
...
?>
  ...
  <div class="blank"></div>
   ...
   <div class="flowBox_in">
        ...
        <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#e4e4e4">
            <tr>
...
?>
    ...
    <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#e4e4e4" id="shippingTable">
            <tr>
...
?>
    ...
    <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#e4e4e4" id="paymentTable">
            <tr>
...
?>
    ...
    <div class="blank"></div>
          ...
          <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#e4e4e4" id="packTable">
            <tr>
              ...
              <th scope="col" bgcolor="#ebf4fb"><?php echo $this->_var['lang']['img']; ?></th>
            </tr>
            <tr>
...
?>
          ...
          <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#e4e4e4" id="cardTable">
            <tr>
...
?>
    ...
    <h5><span><?php echo $this->_var['lang']['fee_total']; ?></span></h5>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/tmall/images/bnt_subOrder.gif" />
  ...
  <img src="themes/tmall/images/step3.gif" />
...
<div class="flowBox">
      ...
      <div class="flowBox_in" style="float:left">   
  ...
  <div class="blank"></div>
        ...
        <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#e4e4e4">
          <tr>
            ...
            <h6 style="background:#e4e4e4"><span>用户登录：</span></h6>
            ...
            <td valign="top" bgcolor="#ffffff">
             <h6 style="background:#e4e4e4"><span>用户注册：</span></h6>
