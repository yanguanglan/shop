...
<div class="block950 block1">
 ...
 <div class="blank" style="height:49px;"></div>
...
<div class="pic f_l"><img src="themes/tmall/images/user.jpg" width="435" height="276" alt="" style="margin:10px 50px 0 0"></div>
  <div class="usBox_1 f_r" style="margin-right:150px;">
  <div class="form-content">
   <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()">
        <table width="100%" border="0" align="left" cellpadding="1" cellspacing="3">
          <tr>
		   <td width="15%">&nbsp;&nbsp;</td>
            <td width="50%" align="left"><?php echo $this->_var['lang']['label_username']; ?>：</td>
           <td width="15%">&nbsp;&nbsp;</td>
          </tr>
		   <tr>
              <td width="15%">&nbsp;&nbsp;</td>
            <td width="50%"><input name="username" type="text" size="25" class="inputBg" /></td>
			 <td width="15%">&nbsp;&nbsp;</td>
          </tr>
          <tr>
		   <td width="15%">&nbsp;&nbsp;</td>
            <td align="left"><?php echo $this->_var['lang']['label_password']; ?>：<a href="user.php?act=get_password" style=" color:#36c; font-weight:normal; padding-left:126px;" target="_blank">忘记登录密码？</a></td>
              <td width="15%">&nbsp;&nbsp;</td>
          </tr>
		   <tr>
             <td width="15%">&nbsp;&nbsp;</td>
          ...
          <tr>
		   <td width="15%">&nbsp;&nbsp;</td>
            <td align="left"><?php echo $this->_var['lang']['comment_captcha']; ?>：</td>
              <td width="15%">&nbsp;&nbsp;</td>
          </tr>
		   <tr>
             <td width="15%">&nbsp;&nbsp;</td>
          ...
          <tr>
           <td>&nbsp;</td>
            <td  align="left"><input type="checkbox" value="1" name="remember" id="remember" /><label  style="font-weight:normal; color:#aaa;"for="remember"><?php echo $this->_var['lang']['remember']; ?></label></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left">
		  ...
		  <tr>
            <td>&nbsp;</td>
			 <td align="right">
			<a style=" color:#36c; font-weight:normal; "  href="user.php?act=register"  target="_blank">注册新用户</a>
			</td>
			</tr>
	  <tr style="display:none"><td></td><td><a href="user.php?act=qpassword_name" class="f3"><?php echo $this->_var['lang']['get_password_by_question']; ?></a>&nbsp;&nbsp;&nbsp;<a href="user.php?act=get_password" class="f3"><?php echo $this->_var['lang']['get_password_by_mail']; ?></a></td></tr>
      </table>
    </form>
	</div>
  </div>
...
<div class="usBox_in "  style="position:relative">
    ...
    <form s action="user.php" method="post" name="formUser" onsubmit="return register();" style="background:none"> <div class="blank"></div> <div class="blank"></div> <div class="blank"></div>
      <table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3" style="background:none">
        <tr>
          <td width="16%" align="right"><?php echo $this->_var['lang']['label_username']; ?>：</td>
          <td width="84%">
	...
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      ...
      <?php endif; ?>
        ...
        <tr>
          ...
          <input type="hidden" name="back_act" value="<?php echo $this->_var['back_act']; ?>" />
           <input name="Submit" type="submit" value="" style=" width:136px; height:35px; border:none; background:url(themes/tmall/images/bnt_ur_reg.gif) no-repeat">
          </td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
