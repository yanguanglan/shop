...
?>
      <tr>
        <td bgcolor="#e5ecfb" style="border-bottom: 1px solid #DADADA">
          <img src="themes/tmall/images/note.gif" alt="no alt" />&nbsp;&nbsp;<strong class="f_red"><?php echo $this->_var['caption']['name']; ?></strong></td>
      </tr>
...
?>
   ...
   <div class="box_1 clearfix">
    <h3><span><?php echo $this->_var['lang']['search_result']; ?> (<?php echo $this->_var['count']; ?>)</span><div class="more f_r" style="clear:both;"><a href="<?php echo $this->_var['url']; ?>">更多</a></div></h3>
...
?>
     <div class="goodsItem2" style="padding-top:10px; text-align:center; height:260px;"  >
           ...
           <p class="name"><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo $this->_var['goods']['short_name']; ?></a></p>
