...
?>
         ...
         <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_97005000_1390445324');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_97005000_1390445324']):
?>  
        <dl>
            <dt><?php echo htmlspecialchars($this->_var['filter_attr_0_97005000_1390445324']['filter_attr_name']); ?>：</dt>
            <dd>
                 <?php $_from = $this->_var['filter_attr_0_97005000_1390445324']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
